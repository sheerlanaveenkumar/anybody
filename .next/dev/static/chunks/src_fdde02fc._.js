...
"[project]/src/components/FaviconSwitcher.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function FaviconSwitcher() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "FaviconSwitcher.useEffect": ()=>{
            const setIcons = {
                "FaviconSwitcher.useEffect.setIcons": async (resolvedTheme)=>{
                    const lightHref = "/favicon.svg";
                    const darkHref = "/favicon.png"; // create this file in public/ for dark mode
                    // prefer dark href when theme is dark; fall back to light if dark icon missing
                    const preferredHref = resolvedTheme === "dark" ? darkHref : lightHref;
                    let finalHref = preferredHref;
                    if (resolvedTheme === "dark") {
                        try {
                            const res = await fetch(darkHref, {
                                method: "HEAD"
                            });
                            if (!res.ok) finalHref = lightHref;
                        } catch  {
                            finalHref = lightHref;
                        }
                    }
                    const setLink = {
                        "FaviconSwitcher.useEffect.setIcons.setLink": (rel, hrefValue, sizes)=>{
                    ...
                    }["FaviconSwitcher.useEffect.setIcons.setLink"];
                    setLink("icon", finalHref, "32x32");
                    setLink("icon", finalHref, "16x16");
                    setLink("shortcut icon", finalHref);
                    setLink("apple-touch-icon", finalHref);
                }
            }["FaviconSwitcher.useEffect.setIcons"];
            const resolve = {
                "FaviconSwitcher.useEffect.resolve": (t)=>{
                    if (!t || t === "system") {
            ...
            }["FaviconSwitcher.useEffect.resolve"];
            setIcons(resolve(theme));
            // If using system theme, listen for changes
            let mql = null;
            const onChange = {
                "FaviconSwitcher.useEffect.onChange": ()=>{
                    if (theme === "system") setIcons(resolve("system"));
                }
            }["FaviconSwitcher.useEffect.onChange"];
...
_s(FaviconSwitcher, "S9l0LnQkvAEC9SClviqVKgL4eb4=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$themes$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTheme"]
    ];
});
_c = FaviconSwitcher;
var _c;
__turbopack_context__.k.register(_c, "FaviconSwitcher");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_fdde02fc._.js.map